...
import love.disaster.j2j.core.chainr.ChainrBuilder;
...
public class Chainr implements Transform, ContextualTransform {
     ...
     * @throws love.disaster.j2j.core.exception.TransformException if the specification is malformed, an operation is not
