...
public class Math {
    ...
    // Enhanced Math Functions - Missing Operations
    
    /**
     * Multiplication operations for different numeric types
     */
    public static Optional<Double> multiply(List<Object> args) {
        ...
        for (Object arg : args) {
            Optional<? extends Number> numberOptional = Objects.toNumber(arg);
            if (numberOptional.isPresent()) {
                result *= numberOptional.get().doubleValue();
            } else {
                return Optional.empty();
            }
        }
     ...
     * Modulo operation
     */
    public static Optional<Double> mod(List<Object> argList) {
        if (argList == null || argList.size() != 2) {
            return Optional.empty();
        }
        
        Optional<? extends Number> dividend = Objects.toNumber(argList.get(0));
        Optional<? extends Number> divisor = Objects.toNumber(argList.get(1));
        
        if (dividend.isPresent() && divisor.isPresent()) {
            double divisorValue = divisor.get().doubleValue();
            if (divisorValue == 0) {
                return Optional.empty();
            }
            
            double result = dividend.get().doubleValue() % divisorValue;
            return Optional.of(result);
        }
    ...
    @SuppressWarnings("unchecked")
    public static final class mod extends Function.ListFunction {
        @Override
        protected Optional<Object> applyList(final List<Object> argList) {
            return (Optional) mod(argList);
        }
    }
     ...
     * Power operation
     */
    public static Optional<Double> pow(List<Object> argList) {
        if (argList == null || argList.size() != 2) {
            return Optional.empty();
        }
        
        Optional<? extends Number> base = Objects.toNumber(argList.get(0));
        Optional<? extends Number> exponent = Objects.toNumber(argList.get(1));
        
        if (base.isPresent() && exponent.isPresent()) {
            double result = java.lang.Math.pow(
                base.get().doubleValue(), 
                exponent.get().doubleValue()
            );
            return Optional.of(result);
        }
    ...
    @SuppressWarnings("unchecked")
    public static final class pow extends Function.ListFunction {
        @Override
        protected Optional<Object> applyList(final List<Object> argList) {
            return (Optional) pow(argList);
        }
    }
     ...
     */
    public static Optional<Double> sqrt(Object arg) {
        Optional<? extends Number> numberOptional = Objects.toNumber(arg);
        if (numberOptional.isPresent()) {
            double value = numberOptional.get().doubleValue();
            if (value < 0) {
                return Optional.empty(); // No complex numbers
            }
            return Optional.of(java.lang.Math.sqrt(value));
        }
        return Optional.empty();
    }
    
    @SuppressWarnings("unchecked")
    public static final class sqrt extends Function.SingleFunction<Double> {
        @Override
     ...
     * Ceiling operation
     */
    public static Optional<Double> ceil(Object arg) {
        Optional<? extends Number> numberOptional = Objects.toNumber(arg);
        if (numberOptional.isPresent()) {
            return Optional.of(java.lang.Math.ceil(numberOptional.get().doubleValue()));
        }
        return Optional.empty();
    }
    
    @SuppressWarnings("unchecked")
    public static final class ceil extends Function.SingleFunction<Double> {
        @Override
        protected Optional<Double> applySingle(final Object arg) {
            return ceil(arg);
        }
     ...
     * Floor operation
     */
    public static Optional<Double> floor(Object arg) {
        Optional<? extends Number> numberOptional = Objects.toNumber(arg);
        if (numberOptional.isPresent()) {
            return Optional.of(java.lang.Math.floor(numberOptional.get().doubleValue()));
        }
        return Optional.empty();
    }
    
    @SuppressWarnings("unchecked")
    public static final class floor extends Function.SingleFunction<Double> {
        @Override
        protected Optional<Double> applySingle(final Object arg) {
            return floor(arg);
        }
     ...
     * Round operation
     */
    public static Optional<Long> round(Object arg) {
        Optional<? extends Number> numberOptional = Objects.toNumber(arg);
        if (numberOptional.isPresent()) {
            return Optional.of(java.lang.Math.round(numberOptional.get().doubleValue()));
        }
        return Optional.empty();
    }
    
    @SuppressWarnings("unchecked")
    public static final class round extends Function.SingleFunction<Long> {
        @Override
