...
import love.disaster.j2j.core.cardinality.CardinalityCompositeSpec;
...
public class CardinalityTransform implements SpecDriven, Transform {
     ...
     * @throws love.disaster.j2j.core.exception.TransformException for a malformed spec or if there are issues during
     * the transform
     */
    @Override
