...
import love.disaster.j2j.core.modifier.function.InnerMath;
...
import static love.disaster.j2j.core.modifier.function.InnerMath.abs;
import static love.disaster.j2j.core.modifier.function.Objects.toNumber;



@SuppressWarnings( "deprecated" )
public class InnerMathTest extends AbstractTester {

    @DataProvider(parallel = true)
    public Iterator<Object[]> getTestCases() {
        List<Object[]> testCases = new LinkedList<>(  );

        Function MAX_OF = new InnerMath.max();
        Function MIN_OF = new InnerMath.min();
        Function ABS_OF = new InnerMath.abs();
        Function TO_INTEGER = new love.disaster.j2j.core.modifier.function.Objects.toInteger();
        Function TO_DOUBLE = new love.disaster.j2j.core.modifier.function.Objects.toDouble();
        Function TO_LONG = new love.disaster.j2j.core.modifier.function.Objects.toLong();

        Function INT_SUM_OF = new InnerMath.intSum();
        Function DOUBLE_SUM_OF = new InnerMath.doubleSum();
        Function LONG_SUM_OF = new InnerMath.longSum();

        Function INT_SUBTRACT_OF = new InnerMath.intSubtract();
        Function DOUBLE_SUBTRACT_OF = new InnerMath.doubleSubtract();
        Function LONG_SUBTRACT_OF = new InnerMath.longSubtract();

        Function DIV_OF = new InnerMath.divide();
        Function DIV_AND_ROUND_OF = new InnerMath.divideAndRound();
